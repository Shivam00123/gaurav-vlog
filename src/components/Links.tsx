...
const Links = () => {
  return (
    //Instagram
    <>
      <a target="_blank" className="w-8 h-8" href={sm_links.instagram}>
        <svg
          enable-background="new 0 0 24 24"
          viewBox="0 0 24 24"
          className="sc-gKsewC cokRez text-textColor"
          fill="currentColor"
        >
          <title data-testid="svgTitle" id="title_0.8805989988513526">
            Instagram
          </title>
      ...
      {/* //WhatsApp */}
      <a target="_blank" className="w-8 h-8" href={sm_links.youtube}>
        <svg
          enable-background="new 0 0 24 24"
          viewBox="0 0 24 24"
          className="sc-gKsewC cokRez text-textColor"
          fill="currentColor"
        >
          <title data-testid="svgTitle" id="title_0.14527231748658664">
            YouTube
          </title>
      ...
      {/* youtube */}
      <a target="_blank" className="w-8 h-8" href={sm_links.whatsapp}>
        <svg
          enable-background="new 0 0 24 24"
          viewBox="0 0 24 24"
          className="sc-gKsewC cokRez text-textColor"
          fill="currentColor"
        >
          <title data-testid="svgTitle" id="title_0.38907396948552864">
            WhatsApp
          </title>
          <g>
      ...
      {/* //facebook */}
      <a target="_blank" className="w-8 h-8" href={sm_links.facebook}>
        <svg
          enable-background="new 0 0 24 24"
          viewBox="0 0 24 24"
          className="sc-gKsewC cokRez text-textColor"
          fill="currentColor"
        >
          <title data-testid="svgTitle" id="title_0.6170621448028762">
            Facebook
          </title>
